...
* Combiner des pages ou des documents de PDF dans un seul PDF
...
* Articles connexes :
   ...
   * [La nouvelle API des services de PDF offre encore plus de fonctionnalités pour les workflows de documents](https://community.adobe.com/t5/acrobat-services-api-discussions/new-pdf-tools-api-brings-more-capabilities-for-document-services/m-p/11294170)
