...
La méthode la plus efficace pour recevoir des notifications lorsque des mises à jour sont modifiées consiste à utiliser des webhooks, que vous pouvez consulter [ici](https://opensource.adobe.com/acrobat-sign/developer_guide/webhookapis.html.
